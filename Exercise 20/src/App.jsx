        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="mb-6">
            <div className="flex gap-2">
              ...
              <button
                type="submit"
                className="px-6 py-2 bg-green-400 text-white font-semibold rounded-lg hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors"
              >
                Add
              </button>
            </div>
